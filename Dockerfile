...
FROM ghcr.io/goauthentik/fips-python:3.13.0-slim-bookworm-fips-full AS python-deps
...
# Stage 6: Run
FROM ghcr.io/goauthentik/fips-python:3.13.0-slim-bookworm-fips-full AS final-image
